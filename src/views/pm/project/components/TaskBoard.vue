              ...
              <el-popover
                ...
                <div class="omit-popover-box">
                      ...
                      <div class="content">
                        ...
                        <div class="btn-box">
                          <el-button
                            size="mini"
                            type="primary"
                            @click="renameTaskListSubmit(item)">Lưu</el-button>
                          <el-button
                            size="mini"
                  ...
                  <p
                    ...
                    @click="createSubTaskClick(item)">Tạo công việc con</p>
                  <p
                    v-if="permission.archiveTask"
                    @click="archiveTaskListClick(item)">Ẩn công việc</p>
                  <p
            ...
            <div
              ...
              <div class="img-group">
                <div
                  ...
                  <span :style="{'color': element.isEnd == 1 && !element.checked ? 'red': '#999'}">{{ element.stopTime | moment("YYYY-MM-DD") }}Kết thúc</span>
                </div>
                <div
      ...
      <div
        ...
        <div
          ...
          <div class="button-box">
            ...
            <el-button
              size="mini"
              @click="createTaskListShow = false">Hủy</el-button>
          </div>
        </div>
      </div>
    </draggable>
