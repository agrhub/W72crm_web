<template>
  <div class="corver">
    <xr-header
      ...
      icon-color="#4AB8B8"
      placeholder="Vui lòng nhập dự án / nhiệm vụ / mô tả"
      label="Dự án"
      show-search
      ft-top="0"
      @search="searchClick">
      ...
      <span class="dropdown-handle">
        <el-dropdown trigger="click" @command="showTypeChange">
          ...
          <el-dropdown-menu slot="dropdown">
            <el-dropdown-item command="board">Xem dạng thẻ</el-dropdown-item>
            <el-dropdown-item command="list">Xem dạng danh sách</el-dropdown-item>
          </el-dropdown-menu>
        </el-dropdown>
        <el-dropdown
          trigger="click"
          ...
          <draggable
            ...
            <template v-else>
              ...
              <project-cell
                ...
                <span slot="body" class="project-cell__add--title">Tạo dự án mới</span>
              </project-cell>
            </template>
          </draggable>
        </el-tab-pane>
