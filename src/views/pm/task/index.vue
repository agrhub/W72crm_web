<template>
  <div class="my-task">
    <xr-header
      ...
      icon-color="#D376FF"
      placeholder="Vui lòng nhập nhiệm vụ / mô tả"
      show-search
      ft-top="0"
      @search="searchClick">
      <span slot="label">Tìm kiếm</span>
      <el-popover
        slot="label"
        ...
        <div class="project-list-popover-btn-list">
          <p @click="exportClick">Xuất file</p>
        </div>
        <i
          slot="reference"
        ...
        <el-dropdown
          ...
          <el-dropdown-menu slot="dropdown">
            ...
            <flexbox class="el-dropdown-footer">
              Các nhiệm vụ đã hoàn thành được xếp hạng cuối cùng theo mặc định<el-switch
                v-model="filterValue.completedTask"
                @change="getList"/>
            </flexbox>
          </el-dropdown-menu>
        </el-dropdown>
        <el-button type="primary" icon="wk wk-screening" class="filter-btn" @click="screeningShow = true">Kiểm tra công việc</el-button>
      </template>
    </xr-header>
              ...
              <div
                ...
                <div class="img-group">
                  <div
                    ...
                    <span :style="{'color': element.isEnd == 1 && !element.checked ? 'red': '#999'}">{{ element.stopTime | moment("YYYY-MM-DD") }} Hoàn thành</span>
                  </div>
                  <div
