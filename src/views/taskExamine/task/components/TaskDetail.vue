      ...
      <div
        ...
        <flexbox
          ...
          <span
            ...
            class="task-hd__top--create">{{ taskData.createUser.realname }} tạo ngày {{ taskData.createTime }}</span>
          <div>
            <span
              v-if="isArchive"
              class="task-hd__top--info">Nhiệm vụ đã được ẩn ngày {{ taskData.archiveTime }}</span>
            <el-button
              v-if="isArchive"
              class="xr-btn--primary"
              icon="wk wk-activation"
              type="primary"
              @click="activateTask">Ẩn</el-button>
            <span
              v-if="isRecycle"
              class="task-hd__top--info">Nhiệm vụ đã được hủy ngày {{ taskData.hiddenTime }}</span>
            <el-button
              v-if="isRecycle && getPermission('restoreTask')"
              class="xr-btn--primary"
              icon="wk wk-activation"
              type="primary"
              @click="recoverTask">Khôi phục</el-button>
            <el-button
            ...
            <el-button
              ...
              icon="wk wk-archive"
              type="primary"
              @click="moreArchive">Tạm xóa</el-button>
            <el-dropdown
          ...
          <div
            ...
            <div class="btn-box">
              <el-button
                type="primary"
                size="mini"
                @click="submiteTaskName(taskDataName)">Lưu</el-button>
              <el-button
                size="mini"
          ...
          <flexbox-item class="priority">
            <flexbox @click.native="priorityVisible = true">
              ...
              <div class="head-btn__bd">
                <div class="head-btn__bd--des">Độ ưu tiên</div>
              </div>
            </flexbox>
          </flexbox-item>
          <flexbox-item>
            <xh-user-cell
              ...
              <flexbox
                ...
                <div class="head-btn__bd">
                  ...
                  <div class="head-btn__bd--des">Người quản lý</div>
                </div>
                <i
            ...
            <flexbox class="head-btn">
              ...
              <div class="head-btn__bd">
                <div
                  ...
                  class="head-btn__bd--title">{{ taskData.startTime | moment('YYYY/MM/DD') }}</div>
                <div class="head-btn__bd--des">Thời gian bắt đầu</div>
              </div>
              <i
            ...
            <flexbox class="head-btn">
              ...
              <div class="head-btn__bd">
                <div
                  ...
                  class="head-btn__bd--title">{{ taskData.stopTime | moment('YYYY/MM/DD') }}</div>
                <div class="head-btn__bd--des">Thời gian kết thúc</div>
              </div>
              <i
        ...
        <div class="main__bd--left">
          <flexbox>
            <flexbox-item class="participant">
              <div class="participant-title">Người thực hiện</div>
              <flexbox
            ...
            <flexbox-item v-if="labelList" class="label">
              <div class="label-title">Nhãn</div>
              <span
          ...
          <div class="secitons">
                ...
                <div v-show="addDescriptionShow">
                  ...
                  <div class="btn-box">
                    <el-button
                      type="primary"
                      size="mini"
                      @click="submiteDescription">Lưu</el-button>
                    <el-button
                      type="text"
                      size="mini"
                      @click="addDescriptionTextarea = '';addDescriptionShow = false">Hủy</el-button>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="section">
              <div class="section__hd">
                ...
                <span>Công việc con ({{ subTaskDoneNum }}/{{ taskData.childTask.length }})</span>
              </div>
              <div class="section__bd">
                      ...
                      <flexbox
                        ...
                        <div class="edit-del-box">
                          <span
                            ...
                            @click="editSubTask(item)">Chỉnh sửa</span>
                          <span
                            v-if="getPermission('deleteChildTask')"
                            class="xr-text-btn delete"
                            @click="deleteSubTask(item)">Xóa</span>
                        </div>

                        <div
                          v-if="item.stopTime"
                          style="margin-left: 8px;"
                          class="bg-color task-bg-color">{{ item.stopTime | moment("YYYY-MM-DD") }} Hoàn thành</div>
                        <xr-avatar
                          v-if="item.mainUser"
            ...
            <div class="section">
              ...
              <div class="section__bd">
                ...
                <el-upload
                  ...
                  <span class="add-btn">
                    <i class="wk wk-l-plus" />
                    <span class="label">Thêm mới</span>
                  </span>
                </el-upload>
              </div>
            </div>
...
export default {
  ...
  methods: {
    ...
    // 更多 ———— 删除和规定按钮
    moreDelete() {
      this.$confirm('Xác nhận xóa?', 'Thành công', {
    ...
    moreArchive() {
      this.$confirm('Xác nhận ẩn?', 'Thông báo', {
        confirmButtonText: 'OK',
        cancelButtonText: 'Cancel',
        type: 'warning',
        customClass: 'is-particulars'
    ...
    unbindRelatedInfo(field, item, index) {
      this.$confirm('Xác nhận hủy liên kết?', 'Thông báo', {
        confirmButtonText: 'OK',
        cancelButtonText: 'Cancel',
        type: 'warning',
        customClass: 'is-particulars'
