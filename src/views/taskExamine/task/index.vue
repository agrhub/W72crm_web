  ...
  <div class="main">
    ...
    <div
        ...
        <flexbox class="header-right" justify="flex-end">
          ...
          <el-popover
            ...
            <el-button
              ...
              @click="taskFilterShow = true">Lọc</el-button>
          </el-popover>
      ...
      <div class="cell-section">
        ...
        <p
          v-if="loading"
          class="scroll-bottom-tips">Tải thêm...</p>
        <p
          v-if="noMore"
...
export default {
  ...
  data() {
    return {
      ...
      moreTypes: [
        {
          type: 'show/hide',
          name: 'Hiển thị nhiệm vụ đã hoàn thành / ẩn nhiệm vụ đã hoàn thành',
          icon: 'eye'
        }
      ],
  ...
  computed: {
    ...
    tabs() {
      if (this.taskType == 1) {
        return [
          ...
          {
            label: 'Bạn là quản lý',
            name: '1'
          },
          {
            label: 'Bạn là thành viên',
            name: '3'
          }
        ]
      } else {
        return [
          ...
          {
            label: 'Cấp dưới quản lý',
            name: '1'
          },
          {
            label: 'Cấp dưới là thành viên',
            name: '3'
          }
        ]
      }
    ...
    title() {
      return this.taskType == 1 ? 'Nhiệm vụ của tôi' : 'Nhiệm vụ của cấp dưới'
    },
