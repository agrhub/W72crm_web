          ...
          <div style="padding: 0 20px; font-size: 12px;">
            ...
            <div class="examine-items">
              <flexbox
                ...
                :key="index"
                class="examine-item">
                <div class="examine-item-name">Trở về {{ (index+1) | numberToZh }} Tiếp tục</div>
                <el-select
                  v-model="item.type"
            ...
            <div class="examine-add-des">
              <p><span class="examine-add-required">*</span>Khi chọn "Người quản lý" để phê duyệt. Hệ thống sẽ chỉ thông báo cho người quản lý.</p>
              ...
              <p><span class="examine-add-required">*</span>Khi bạn chọn "Người dùng được chỉ định (Một trong số)", điều đó có nghĩa là bất kỳ ai trong số những người dùng được chỉ định đều có thể phê duyệt. Khi chọn "Người dùng được chỉ định (Tất cả)", điều đó có nghĩa là tất cả người dùng được chỉ định phải phê duyệt.</p>
            </div>
            <el-radio
              v-model="examineType"
      ...
      examineList: [
        {
          ...
          show: false,
          options: [
            { name: 'Người quản lý trực tiếp', value: 1 },
            { name: 'Người được chỉ định (một trong số)', value: 2 },
            { name: 'Người được chỉ định (tất cả cùng ký)', value: 3 }
          ]
        }
      ]
    }
  ...
  methods: {
    ...
    getField() {
      ...
      const categoryTypeList = [
        ...
        { name: 'Thanh toán', value: 2 },
        { name: 'Hóa đơn', value: 3 },
        { name: 'Tiền lương', value: 4 },
        ...
        { name: 'Phê duyệt chính sách thanh toán', value: 9 },
      ...
      field.push({
        ...
        name: 'Ghi chú',
        setting: [],
        inputTips: 'Vui lòng điền các ghi chú liên quan để nhân viên tiện kiểm tra khi ứng tuyển, hạn chế nhập 200 từ',
