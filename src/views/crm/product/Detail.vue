                ...
                <sections
                  ...
                  <div class="image">
                    <div v-if="mainFileList.length > 0" class="image-info">
                      <div class="image-info__label">Hình ảnh sản phẩm</div>
                    ...
                    <div v-if="detailFileList.length > 0" class="image-info">
                      <div class="image-info__label">Hình ảnh chi tiết sản phẩm</div>
                      <div class="image-info__list">
                        <img
                          v-src="item.url"
                    ...
                    <div v-if="detailFileList.length == 0 && mainFileList.length == 0" class="no-img">Không có ảnh</div>
                  </div>
                </sections>
              </c-r-m-edit-base-info>
              <component
  ...
  computed: {
    tabNames() {
      return [
        ...
        { label: this.getTabName('Đính kèm', this.tabsNumber.fileCount), name: 'RelativeFiles' },
