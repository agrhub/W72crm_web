  ...
  <div>
    ...
    <div
      ...
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            <el-tooltip :content="scope.row.star == 0 ? 'Thêm theo dõi': 'Bỏ theo dõi'" effect="dark" placement="top">
              <i
      ...
      <div class="p-contianer">
        ...
        <span v-if="moneyPageData" class="money-bar">Số tiền cơ hội：{{ moneyPageData.businessSumMoney || 0 | separator }}</span>
      </div>
    </div>
    <!-- 相关详情页面 -->
    <c-r-m-all-detail
