  ...
  <div
    ...
    <flexbox
      ...
      <el-button
        ...
        icon="el-icon-plus"
        type="primary"
        @click="createClick">Cơ hội kinh doanh mới</el-button>
      <el-button
        v-if="canRelation"
        class="rc-head-item"
        type="primary"
      ...
      <el-popover
        ...
        <el-button
          ...
          type="primary"
          @click.native="showRelativeView = true">Có liên quan</el-button>
      </el-popover>
...
export default {
  ...
  methods: {
    ...
    getFieldList() {
      ...
      this.fieldList.push({ prop: 'statusName', width: '200', label: 'Giai đoạn cơ hội' })
    },
