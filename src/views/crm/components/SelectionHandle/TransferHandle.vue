  ...
  <el-dialog
    ...
    <div class="handle-box">
      <flexbox class="handle-item">
        <div class="handle-item-name">Người chịu trách nhiệm thay đổi là：</div>
        <xh-user-cell
          :value="usersList"
      ...
      <flexbox
        v-if="showRemoveType"
        class="handle-item">
        <div class="handle-item-name">Người phụ trách ban đầu：</div>
        <el-radio-group v-model="removeType">
          <el-radio :label="1">Nghỉ việc</el-radio>
          <el-radio :label="2">Chuyển nhóm khác</el-radio>
        </el-radio-group>
      </flexbox>
      <flexbox
        v-if="removeType == 2"
      ...
      <flexbox
        ...
        class="handle-item">
        <div class="handle-item-name">Đồng thời thay đổi người phụ trách thành：</div>
        <el-checkbox-group v-model="addsTypes">
          <el-checkbox label="1">Người liên hệ</el-checkbox>
