  ...
  <div
    ...
    <flexbox
      ...
      <el-button
        ...
        icon="el-icon-plus"
        type="primary"
        @click="createClick">Danh bạ mới</el-button>
      <el-button
        v-if="canRelation"
        class="rc-head-item"
        type="primary"
        @click.native="unRelevanceHandleClick">Hủy liên kết</el-button>
      <el-popover
        v-if="canRelation"
        ...
        <el-button
          ...
          type="primary"
          @click.native="showRelativeView = true">Các liên kết</el-button>
      </el-popover>
        ...
        <template slot-scope="scope">
          <flexbox justify="center">
            <span
              ...
              class="chief">
            <i class="wk wk-success" />Danh bạ chính</span>
            <el-button
              v-else
              class="set-chief-btn"
              type="text"
              @click.native="setChieflyContacts(scope)">Đặt làm danh bạ chính</el-button>
          </flexbox>
        </template>
      </el-table-column>
    </el-table>
  ...
  methods: {
    ...
    unRelevanceHandleClick() {
      if (this.selectionList.length == 0) {
        this.$message.error('Vui lòng kiểm tra dữ liệu trước')
      } else {
    ...
    getFieldList() {
      ...
      this.fieldList.push({ prop: 'mobile', width: '200', label: 'Số điện thoại' })
