  ...
  <div v-loading="loading" class="rc-cont">
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <flexbox>
            ...
            <el-button
              type="text"
              @click.native="handleFile('download', scope)">Tải về</el-button>
            <el-button
    ...
    <el-dialog
      ...
      <div
        slot="footer"
        class="dialog-footer">
        <el-button @click="editDialog = false">Hủy</el-button>
        <el-button
          type="primary"
...
export default {
  ...
  mounted() {
    ...
    this.fieldList.push({ prop: 'size', width: '100', label: 'Kích thước' })
    this.fieldList.push({
      prop: 'createUserName',
      width: '100',
      label: 'Người tải lên'
    ...
    this.fieldList.push({ prop: 'source', width: '100', label: 'Nguồn' })
    this.getDetail()
