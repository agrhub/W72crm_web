  ...
  <div
    ...
    <flexbox
      ...
      <el-button
        ...
        icon="el-icon-plus"
        type="primary"
        @click="createClick">Hợp đồng mới</el-button>
    </flexbox>
    <el-table
      :data="list"
      :height="tableHeight"
...
export default {
  ...
  methods: {
    getFieldList() {
      ...
      this.fieldList.push({ prop: 'num', width: '200', label: 'Mã hợp đồng' })
      this.fieldList.push({
        prop: 'customerName',
        width: '200',
        label: 'Tên khách hàng'
      })
      this.fieldList.push({ prop: 'money', width: '200', label: 'Giá trị hợp đồng' })
      this.fieldList.push({
        prop: 'startTime',
        width: '200',
        label: 'Ngày bắt đầu'
