  ...
  <div class="c-container">
    ...
    <el-input
      ...
      <el-button
        slot="append"
        type="primary"
        @click.native="searchInput">Tìm kiếm</el-button>
    </el-input>
    <div class="right-container">
      ...
      <el-button
        v-if="showDupCheck"
        class="dup-check-btn"
        @click="dupCheckShow = true">Kiểm tra trùng lặp</el-button>
      <el-dropdown
...
export default {
  ...
  mounted() {
    ...
    if (this.crm[this.crmType] && this.crm[this.crmType].excelimport) {
      this.moreTypes.push({ type: 'enter', name: 'Nhập từ file', icon: 'import' })
    }
    if (this.crm[this.crmType] && this.crm[this.crmType].excelexport) {
      this.moreTypes.push({ type: 'out', name: 'Xuất file', icon: 'export' })
    }
