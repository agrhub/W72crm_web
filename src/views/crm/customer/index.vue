<template>
  <div>
    <c-r-m-list-head
      ...
      placeholder="Vui lòng nhập tên khách hàng / điện thoại di động / điện thoại"
    ...
    <div
      ...
      <el-table
        ...
        <el-table-column
          ...
          width="60">
          <template slot-scope="scope">
            <el-tooltip :content="scope.row.star == 0 ? 'Theo dõi': 'Bỏ theo dõi'" effect="dark" placement="top">
              <i
