<template>
  <div style="height:100%;">
    <flexbox class="message-header"><img
      ...
      class="title-icon">
      <span class="title">Công việc cần làm</span>
    </flexbox>
...
export default {
  ...
  data() {
    return {
      ...
      leftSides: [
        {
          name: 'Liên hệ KH tiềm năng hôm nay',
          crmType: 'leads',
          color: '#2362FB',
          ...
          model: 11,
          num: 0,
          tips: 'Lần liên hệ tiếp theo là ngày hôm nay',
          hidden: true
        },
        {
          name: 'Liên hệ KH ngay hôm nay',
          crmType: 'customer',
          color: '#2362FB',
        ...
        {
          name: 'Liên hệ cơ hội ngay hôm nay',
          crmType: 'business',
          color: '#2362FB',
        ...
        },
        {
          ...
          model: 2,
          num: 0,
          tips: 'Khách hàng tiềm năng không được theo dõi sau khi chuyển giao',
          hidden: true
        },
        {
          name: 'Khách hàng được giao',
          crmType: 'customer',
          color: '#19B5F6',
          ...
          model: 3,
          num: 0,
          tips: 'Những khách hàng không theo dõi sau khi chuyển, nhận và phân công sẽ hiển thị theo mặc định',
          hidden: true
        },
        {
          name: 'Khách hàng chờ bị loại',
          crmType: 'customer',
          color: '#26D4DA',
        ...
        },
        {
          ...
          model: 8,
          num: 0,
          tips: 'Lời nhắc dựa trên "Thời gian hết hạn hợp đồng" và "Số ngày nhắc trước"',
          hidden: true
        },
        {
          name: 'Hợp đồng mua lặp chờ được xử lý',
          crmType: 'contract',
          color: '#ff9232',
