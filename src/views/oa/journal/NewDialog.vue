    ...
    <div
      ...
      <div class="content">
        ...
        <div class="form">
          ...
          <div class="sent-who">
            <span class="cursor-default">Người nhận：</span>
            <span
            ...
            <members-dep
              ...
              <span slot="membersDep">
                <el-tooltip
                  ...
                  popper-class="tooltip-change-border">
                  <div slot="content">
                    <span>{{ `Gởi đến ${formData.sendUserList.length} người` }}</span>
                  </div>
                  <i
  ...
  data() {
    return {
      ...
      dateList: [
        ...
        { label: 'Những vấn đề bắt gặp', model: 'question' }
      ],
      weekList: [
        { label: 'Nội dung công việc tuần này', model: 'content' },
        { label: 'Nội dung công việc tuần sau', model: 'tomorrow' },
        { label: 'Những vấn đề bắt gặp', model: 'question' }
      ],
      monthList: [
        { label: 'Nội dung công việc tháng này', model: 'content' },
        { label: 'Nội dung công việc tháng sau', model: 'tomorrow' },
        { label: 'Những vấn đề bắt gặp', model: 'question' }
      ],
      batchId: guid(),
      imageFileList: [],
    ...
    if (this.formData.categoryId) {
      switch (this.formData.categoryId) {
        case 1:
          ...
          break
        case 2:
          this.tabsData = [{ label: 'Hằng tuần', key: '2' }]
          this.formList = this.weekList
          this.activeName = '2'
          break
        case 3:
          this.tabsData = [{ label: 'Hằng tháng', key: '3' }]
