<template>
  <div
    ...
    <filtrate-handle-view
      ...
      title="Xếp hạng liên lạc khách hàng"
      class="filtrate-bar"
      module-type="ranking"
      @load="loading=true"
      @change="getDataList"/>
    <div class="content">
      <div class="content-title">Xếp hạng liên lạc khách hàng (theo nhân viên và thời gian liên lạc)</div>
      <div
...
export default {
  ...
  mounted() {
    this.fieldList = [
      ...
      { field: 'count', name: 'Số khách hàng liên hệ （lượt）' }
    ]
    this.initAxis()
  },
  methods: {
