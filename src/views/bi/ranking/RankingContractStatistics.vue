<template>
  <div
    ...
    <filtrate-handle-view
      ...
      title="Xếp hạng giá trị hợp đồng"
      class="filtrate-bar"
      module-type="ranking"
      @load="loading=true"
      @change="getDataList"/>
    <div class="content">
      <div class="content-title">Xếp hạng giá trị hợp đồng (theo thời gian đặt hàng thực tế)</div>
      <div
...
export default {
  ...
  mounted() {
    this.fieldList = [
      ...
      { field: 'money', name: 'Giá trị hợp đồng （đồng）' }
    ]
    this.initAxis()
  },
  methods: {
