<template>
  <div
    ...
    <filtrate-handle-view
      title="High Seas Customer Analysis"
      class="filtrate-bar"
  ...
  data() {
    return {
      ...
      fieldList: [
        ...
        { field: 'receiveNum', name: 'Số lượng khách hàng nhận vào' },
        { field: 'putInNum', name: 'Số lượng khách hàng bị loại ra' }
      ]
    }
  },
  computed: {
  ...
  methods: {
    ...
    initAxis() {
      ...
      var option = {
        ...
        legend: {
          data: ['Số lượng khách hàng bị loại ra', 'Số lượng khách hàng nhận vào'],
          bottom: '0px',
          itemWidth: 14
        },
        grid: {
        ...
        yAxis: [
          {
            type: 'value',
            name: 'Số lượng khách hàng bị loại ra',
            axisTick: {
              alignWithLabel: true,
              lineStyle: { width: 0 }
            },
          ...
          {
            type: 'value',
            name: 'Số lượng khách hàng nhận vào',
            axisTick: {
              alignWithLabel: true,
              lineStyle: { width: 0 }
            },
