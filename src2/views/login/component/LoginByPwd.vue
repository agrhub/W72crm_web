...
export default {
  ...
  data() {
    ...
    return {
      ...
      rules: {
        username: [{ required: true, msg: 'Tên ngươi dung không được để trông' }],
        password: [
          { required: true, msg: 'Mật khẩu không được để trống' },
          { reg: pwdReg, msg: 'Mật khẩu bao gồm 6-20 chữ cái và số' }
        ]
      }
    }
  },
