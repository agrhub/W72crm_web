    ...
    <flexbox
      ...
      <div class="detail-body">
        ...
        <div
          ...
          <div class="table-sections__title">Công tác</div>
          <el-table
            :data="travelList"
        ...
        <div
          ...
          class="table-sections">
          <div class="table-sections__title">Hoàn trả</div>
          <el-table
            :data="travelList"
            style="font-size: 13px;"
            align="center"
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                <flexbox justify="center">
                  <el-button
                    type="text"
                    @click.native="handleFile('preview', scope.row.img, 0)">{{ scope.row.img ? scope.row.img.length : 0 }}Xem</el-button>
                </flexbox>
              </template>
            </el-table-column>
          </el-table>
...
export default {
  ...
  data() {
    return {
      ...
      travelList: [],
      travelField: [
        { prop: 'vehicle', label: 'Phương tiện di chuyển' },
        { prop: 'trip', label: 'Loại công tác' },
        ...
        { prop: 'description', label: 'Ghi chú' }
      ],
      expensesField: [
        { prop: 'startAddress', label: 'Điểm đi' },
        { prop: 'endAddress', label: 'Điểm đến' },
        { prop: 'startTime', label: 'Ngày đi' },
        { prop: 'endTime', label: 'Ngày về' },
        { prop: 'traffic', label: 'Chi phí đi lại （đồng）' },
        { prop: 'stay', label: 'Chi phí ở （đồng）' },
        { prop: 'diet', label: 'Chi phí ăn （đồng）' },
        { prop: 'other', label: 'Chi phí khác （đồng）' },
        { prop: 'description', label: 'Ghi chú' }
      ],
