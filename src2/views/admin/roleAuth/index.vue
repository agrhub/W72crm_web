<template>
  <div class="role-authorization">
    <xr-header
      ref="xrHeader"
      show-search
      label="Kiểm soát quyền của vai trò"
          ...
          <el-tab-pane
            ...
            <div
              ...
              <el-table
                ...
                <el-table-column label="Tủy chọn">
                      ...
                      <el-tree
                        ...
                        <span
                          ...
                          :class="{ 'node-label': node.level == 1 || node.level == 2} ">{{ node.label }}<el-button
                            ...
                            icon="wk wk-manage"
                            type="text"
                            @click="fieldSetClick(node)" >Kiểm tra trường</el-button></span>
                      </el-tree>
                    </div>
                  </div>
                  <div
                    ...
                    <div class="data-radio">
                      <el-radio-group v-model="item.value">
                        <el-radio :label="1">Chính bạn</el-radio>
                        <el-radio :label="2">Bạn và cấp dưới</el-radio>
                        <el-radio :label="3">Phòng ban</el-radio>
                        <el-radio :label="4">Phòng ban và các bộ phận liên quan</el-radio>
                        <el-radio :label="5">Công ty</el-radio>
                      </el-radio-group>
                    </div>
                  </div>
  ...
  data() {
    return {
      ...
      tableList: [
        ...
        { label: 'Phòng ban', field: 'deptName' },
        { label: 'Chức vụ', field: 'post' },
        { label: 'Vai trò', field: 'roleName' }
      ],
  ...
  methods: {
    ...
    getReminderContent() {
      if (this.roleActive && this.roleActive.remark == 'project') {
        return 'The project administrator has all the permissions of the "Project Management" module, can see and maintain all project information'
      }
      return ''
    },
     ...
     */
    ticketsBtn(val) {
      this.$confirm('Xác nhận sao chép?', 'Thông báo', {
        confirmButtonText: 'OK',
        cancelButtonText: 'Cancel',
        type: 'warning'
      })
