    ...
    <div
      ...
      <div class="nav-manager__content">
        ...
        <div class="nav-section">
          <div class="nav-section__title" title="123123">Tất cả các ứng dụng</div>
          <flexbox
        ...
        <div class="nav-section">
          <div class="nav-section__title">Ứng dụng hàng đầu<span class="nav-section__tips">(Có thể đặt tối đa 8 ứng dụng hàng đầu, có thể sắp xếp bằng cách kéo)</span>
            <el-button v-if="isEdit" type="primary" @click="saveClick">Lưu</el-button>
            <el-button v-else @click="isEdit = !isEdit">Chỉnh sửa</el-button>
          </div>
          <draggable
            v-model="topList"
