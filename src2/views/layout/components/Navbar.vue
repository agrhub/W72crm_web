  ...
  <div class="navbar">
    ...
    <el-dropdown
      ...
      <el-dropdown-menu
        ...
        <div v-if="manage && !isNewest" class="wk-update-tips">Phiên bản mới<el-badge is-dot><el-button type="primary" round @click="updateClick">Cập nhật</el-button></el-badge></div>
        <div
          v-if="manage"
          class="handel-box">
          <el-button
  ...
  computed: {
    ...
    moreMenu() {
      return [{
        ...
        command: 'version',
        divided: false,
        label: `Phiên bản ${WKConfig.version}`,
        icon: 'wk wk-version',
        disabled: true
      }]
    },
