<template>
  <div
    ...
    <filtrate-handle-view
      ...
      :custom-options="[{name:'Biểu đồ đường', value: 'line'}, {name:'Biểu đồ bánh', value: 'pie'},{name:'Biểu đồ cột', value: 'bar'}]"
      title="Phân tích tỷ lệ chuyển đổi khách hàng"
      class="filtrate-bar"
  ...
  data() {
    return {
      ...
      fieldReportList: [
        ...
        { prop: 'contractName', label: 'Tiêu đề hợp đồng' },
        { prop: 'contractMoney', label: 'Số tiền hợp đồng (đồng)' },
        { prop: 'receivablesMoney', label: 'Số tiền đã thanh toán (đồng)' },
        { prop: 'ownerUserName', label: 'Người tạo' },
        { prop: 'createTime', label: 'Ngày tạo' },
        { prop: 'orderDate', label: 'Ngày mua hàng' }
      ],
      reportData: {
        title: '',
        placeholder: '',
