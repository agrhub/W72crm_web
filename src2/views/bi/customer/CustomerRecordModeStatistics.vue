<template>
  <div
    ...
    <filtrate-handle-view
      ...
      :custom-options="[{name:'Biểu đồ tròn', value: 'pie'},{name:'Biểu đồ cột', value: 'bar'}]"
      title="Phân tích liên lạc khách hàng"
      class="filtrate-bar"
...
export default {
  ...
  data() {
    return {
      ...
      list: [],
      fieldList: [
        { field: 'category', name: 'Phương pháp liên lạc' },
        { field: 'recordNum', name: 'Số lượt liên lạc' },
