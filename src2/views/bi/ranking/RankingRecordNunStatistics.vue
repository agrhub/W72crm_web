<template>
  <div
    ...
    <filtrate-handle-view
      ...
      title="Xếp hạng các lượt liên lạc"
      class="filtrate-bar"
      module-type="ranking"
      @load="loading=true"
      @change="getDataList"/>
    <div class="content">
      <div class="content-title">Xếp hạng thời gian liên lạc (dựa trên thời gian thăm hỏi)</div>
      <div
...
export default {
  ...
  mounted() {
    this.fieldList = [
      ...
      { field: 'count', name: 'Thời gian liên lạc (lần)' }
    ]
    this.initAxis()
  },
  methods: {
