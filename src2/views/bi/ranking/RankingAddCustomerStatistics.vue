...
export default {
  ...
  mounted() {
    this.fieldList = [
      { field: 'realname', name: 'Người tạo' },
      { field: 'structureName', name: 'Phòng ban' },
      { field: 'count', name: 'Số lượng khách hàng mới （người）' }
    ]
    this.initAxis()
  },
  methods: {
    ...
    initAxis() {
      ...
      this.axisOption.tooltip.formatter = '{b} : {c} người'
      this.axisOption.xAxis[0].name = '（người）'
      this.chartObj.setOption(this.axisOption, true)
    },
