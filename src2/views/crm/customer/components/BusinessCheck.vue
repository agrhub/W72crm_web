<template>
  <div
    ...
    <div class="header">
      ...
      <span class="detail">{{ `Số lượng cơ hội kinh doanh：（${list.length}） lượt` }}</span>
...
export default {
  ...
  mounted() {
    ...
    this.fieldList.push({ prop: 'typeName', width: '200', label: 'Loại cơ hội' })
    this.fieldList.push({ prop: 'statusName', width: '200', label: 'Trạng thái cơ hội' })
  },
  methods: {
    getDetail() {
      this.loading = true
