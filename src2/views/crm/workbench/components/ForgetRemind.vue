<template>
  <div
    ...
    <flexbox class="card-title">
      ...
      <div class="card-title-center text-one-ellipsis">Lời nhắc khi quên</div>
    </flexbox>
    <div class="card-desc">
      Sắp xếp và tổng hợp những khách hàng chưa được liên hệ trong một khoảng thời gian
    </div>
...
export default {
  ...
  data() {
    return {
      data: [
        {
          label: 'Khách hàng đã hơn 7 ngày không được liên lạc',
          value: 0,
          key: 'sevenDays',
          hidden: false
        },
        {
          label: 'Khách hàng đã hơn 15 ngày không được liên lạc',
          value: 0,
          key: 'fifteenDays',
          hidden: false
        },
        {
          label: 'Khách hàng đã hơn 1 tháng không được liên lạc',
          value: 0,
          key: 'oneMonth',
          hidden: false
        },
        {
          label: 'Khách hàng đã hơn 3 tháng không được liên lạc',
          value: 0,
          key: 'threeMonth',
          hidden: false
        },
        {
          label: 'Khách hàng đã hơn 6 tháng không được liên lạc',
          value: 0,
          key: 'sixMonth',
          hidden: false
        },
        {
          label: 'Khách hàng không được liên lạc sau ngày đến hạn',
          value: 0,
  ...
  methods: {
    ...
    reportClick(item) {
      ...
      this.reportData.placeholder = 'Vui lòng nhập tên khách hàng / điện thoại di động / điện thoại'
