<template>
  <div
    ...
    <flexbox class="card-title">
      ...
      <div class="card-title-center text-one-ellipsis">{{ typeName }} - Mục tiêu danh số và trạng thái hoàn thành</div>
    ...
    <div class="card-desc">
      Biểu đồ thành tích mục tiêu {{ typeName }} năm ngoái
      <el-button v-if="hasSetAuth" style="margin-left: 8px;" type="text" @click="enterSetPage">Mục tiêu đề ra</el-button>
    </div>
...
export default {
  ...
  data() {
    return {
      options: [
        { name: 'Giá trị hợp đồng', value: 1 },
        { name: 'Số tiền thanh toán', value: 2 }
      ],
      optionName: 'Giá trị hợp đồng',
      optionValue: 1,
      chartOption: {
        color: ['#6ca2ff', '#ff7474'],
        tooltip: {
        ...
        legend: {
          right: '20px',
          data: ['Doanh số mục tiêu tháng', 'Danh số đạt được']
        },
        xAxis: [
          {
            type: 'category',
