    ...
    <div class="crm-workbench__body">
      <div
        ...
        <div class="brief-title">
          ...
          <span class="text">Tổng hợp bán hàng</span>
        </div>
        <div class="brief">
          <flexbox
...
export default {
  ...
  data() {
    return {
      briefList: [
        { label: 'Khách hàng mới (người)', title: 'Khách hàng mới', type: 'customer', labelValue: 2, field: 'customerCount', icon: 'wk-customer', num: '', rate: '', status: '', color: '#2362FB' },
        { label: 'Danh bạ mới (người)', title: 'Danh bạ mới', type: 'contacts', labelValue: 3, field: 'contactsCount', icon: 'wk-contacts', num: '', rate: '', status: '', color: '#27BA4A' },
        { label: 'Cơ hội mới (lượt)', title: 'Cơ hội mới', type: 'business', labelValue: 5, field: 'businessCount', icon: 'wk-business', num: '', rate: '', status: '', color: '#FB9323' },
        { label: 'Hợp đồng mới (lượt)', title: 'Hợp đồng mới', type: 'contract', labelValue: 6, field: 'contractCount', icon: 'wk-contract', num: '', rate: '', status: '', color: '#4A5BFD' },
        { label: 'Thanh toán mới (đồng)', title: 'Thanh toán mới', type: 'contract', labelValue: 6, field: 'contractMoney', icon: 'wk-receivables', num: '', rate: '', status: '', color: '#19B5F6' },
        { label: 'Giá trị cơ hội mới (đồng)', title: 'Giá trị cơ hội mới', type: 'business', labelValue: 5, field: 'businessMoney', icon: 'wk-icon-opportunities', num: '', rate: '', status: '', color: '#AD5CFF' },
        { label: 'Giá trị thanh toán mới (đồng)', title: 'Giá trị thanh toán mới', type: 'receivables', labelValue: 7, field: 'receivablesMoney', icon: 'wk-receivables', num: '', rate: '', status: '', color: '#FFB940' },
        { label: 'Theo dõi mới (lượt)', title: 'Theo dõi mới', type: 'record', labelValue: '', field: 'recordCount', icon: 'wk-record', num: '', rate: '', status: '', color: '#4A5BFD' }
      ],
      rangeOptions: [
        { label: 'Chỉ bạn', command: 1 },
        { label: 'Bạn và cấp dưới', command: 2 },
        { label: 'Cả phòng ban', command: 3 },
        { label: 'Phòng ban và các bộ phận trực thuộc', command: 4 },
        { label: 'Tùy biến', command: 'custom' }
      ],
    ...
    avatarData() {
      ...
      return {
        ...
        realname: {
          ...
          2: 'Bạn và cấp dưới',
          3: 'Phòng ban',
          4: 'Phòng ban và các bộ phận trực thuộc'
  ...
  methods: {
    ...
    reportClick(item) {
      if (item.type) {
        this.reportData.title = `Tóm tắt bán hàng - ${item.title}`
        this.reportData.placeholder = {
          customer: 'Vui lòng nhập tên khách hàng / điện thoại di động / điện thoại',
          contacts: 'Vui lòng nhập tên liên hệ / điện thoại di động / điện thoại',
          business: 'Vui lòng nhập tên cơ hội',
          business_status: 'Vui lòng chọn trạng thái cơ hội',
    ...
    chartClick(chartData, data) {
      this.reportData.title = `Phễu bán hàng - ${data.name}`
      this.reportData.placeholder = 'Vui lòng nhập tên cơ hội'
