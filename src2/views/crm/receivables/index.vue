<template>
  <div>
    <c-r-m-list-head
      ...
      placeholder="Vui lòng nhập tên khách hàng / số biên nhận"
    ...
    <div
      ...
      <div class="p-contianer">
        ...
        <span v-if="moneyPageData" class="money-bar">Số tiền thanh toán：{{ moneyPageData.receivablesMoney || 0 | separator }}</span>
      </div>
    </div>
    <!-- 相关详情页面 -->
    <c-r-m-all-detail
