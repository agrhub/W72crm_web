<template>
  <div
    ...
    <el-table
      ...
      <el-table-column prop="down" label="Tùy chọn" width="80px">
        <template slot-scope="scope">
          <el-button class="el-button--primary" type="text" @click="print(scope.row)">Xem trước khi in</el-button>
        </template>
      </el-table-column>
    </el-table>
  </div>
...
export default {
  ...
  data() {
    return {
      ...
      list: [],
      fieldList: [
        { prop: 'createTime', label: 'Ngày tạo', width: '115px' },
        { prop: 'templateName', label: 'Mẫu in', width: '115px' }
      ],
      tableHeight: '450px'
    }
  },
