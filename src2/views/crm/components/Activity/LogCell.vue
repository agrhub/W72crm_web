    ...
    <flexbox class="fl-h">
      ...
      <el-dropdown
        ...
        <el-dropdown-menu slot="dropdown">
          <el-dropdown-item v-if="hasEditAuth" command="edit">Chỉnh sửa</el-dropdown-item>
          <el-dropdown-item v-if="hasDeleteAuth" command="delete">Xóa</el-dropdown-item>
        </el-dropdown-menu>
      </el-dropdown>
    </flexbox>
    <div class="fl-b">
      ...
      <div v-if="item.file && item.file.length > 0">
        <flexbox
          ...
          <div class="cell-ft">
            ...
            <a @click="previewImg(item.file, index)">Xem trước</a>
            <a @click="downloadFile(file)">Tải về</a>
          </div>
        </flexbox>
      </div>
      ...
      <div v-if="item.nextTime" class="cell-top">
        <flexbox
          ...
          <div class="cell-bd text-one-line">
            Lần liên hệ tiếp theo：{{ item.nextTime }}
          </div>
        </flexbox>
      </div>
